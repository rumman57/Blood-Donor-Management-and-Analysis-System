          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                 <tr>
                  ...
                  <th style="text-align: center;" width="40%">Name/Link</th>
                  <th style="text-align: center;" width="40%">Imagae</th>  
              ...
              <?php $i++;?>
                <tr>
                  <td>{{$i}}</td>
                  <td>{{URL::asset('uploads/'.$image->image)}}</td>
                  <td><img src="{{URL::asset('uploads/'.$image->image)}}" height="150" width="150"></td>
                  <td>
                    <form method="POST" action="{{action('Myadmin\ImageController@DeleteImage',['id'=>$image->id])}}">
                        {{method_field('DELETE')}}
                        {{csrf_field()}}
